...
| 文件扩展名 | 文件内容 |
| --- | --- |
| .br | 元件——有关元件（例如 74LSo2）的数据，包括逻辑系列、属性、 Pin 和门。 |
...
库项目名称显示在 PCB 封装、元件类型、线项目或 CAE 封装列表中。（列表名称会根据您选择的过滤器而变化。）预览窗口会显示库对象的图形。
...
1. 在“PCB 封装”、“元件类型”、“行项目”或“CAE 封装”列表中选择一个或多个项目。（列表名称会根据您选择的过滤器而变化。）
...
• 封装 — 打开将 PCB 封装保存到库对话框 • 元件 — 打开将元件类型保存到库对话框 线条 — 打开将绘图项目保存到库对话框 • 逻辑 — 打开将 CAE 封装保存到库对话框
...
• 如果文件类型为.c，请选择“逻辑”过滤器。此 ASCII 文件包含 CAE 封装（逻辑符号）。
• 如果文件类型为.l，请选择“线”过滤器。此 ASCII 文件包含绘图对象。
• 如果文件类型为 .d，请选择“封装”过滤器。此 ASCII 文件包含 PCB 封装（元件封装）。
...
1. （可选）您可以优化要报告的元件列表。在“元件过滤器”字段中，输入元件名称或使用通配符 $(^{\star})$ 指定一组元件，然后点击“应用”。
2. 单击运行。
...
“库”、“元件名称”、“元件编号”、“描述”、“制造商 #1”、“pcB 封装 1” “anlogdeV”、“AD1315”、“AD1315KZ”、“带抑制功能的高速有源负载” “ANALOG DEVICES”、“Z-16A”、“anlogdev”、“AD1321”、“AD1321KZ”、“带抑制功能的高速 Pin 驱动器”、“ANALOG DEVICES”、“Z-16A”， “anlogdew”、“AD1322”、“AD13ZZKZ”、“带抑制功能的超高速 Pin 驱动器” “ANALOG DEVICES”、“Z-16A”， “anlogdev”、“AD1376”、“AD1376 (,KD)、“高速 16 位 A/D 转换器”、“ANALOG DEVICES",“DH-3ZE", “anlogdev","AD1377","AD1377 (,K)D","高速，16 位 A/D 转换器","ANALOG DEVICES","DH-32E" “anlogdev","AD1382","AD1382KD","16 位，500KHZ，采样 ADC","ANALOG DEVICES","DH-48A"，
...
1. 在过滤器区域中，单击封装、线条或逻辑过滤器。

对话框中会出现库中相应项目的列表（在“PCB 封装”、“线条项目”或“CAE 封装”区域中，取决于您的过滤器选择）。
