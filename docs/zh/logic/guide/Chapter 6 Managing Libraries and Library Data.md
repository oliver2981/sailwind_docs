...
| 文件扩展名 | 文件内容 |
| --- | --- |
| .br | 元件——有关元件（例如 74LSo2）的数据，包括逻辑系列、属性、引脚和门。 |
