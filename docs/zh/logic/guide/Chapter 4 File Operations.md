...
将各种格式的数据插入当前示意图。
转换使用其他工具创建的原理图，并将其作为新的 SailWind Logic 原理图打开。此功能调用符号和原理图转换程序的非 GUI 实例来转换单个设计，使用位于 C:<install\_folder><version>\\Settings 中的默认映射文件（cadstar2pl.cnv、orcad2pl.cnv、pcad2pl.cnv 和 protel2pl.cnv）。
