...
<table><thead><tr><th><br>表达</th><th><br>使用</th></tr></thead><tbody><tr><td>*</td><td><br>匹配任意数量的字符。</td></tr><tr><td>？</td><td><br>匹配任意一个字符。</td></tr><tr><td><br>[放]</td><td><br>匹配指定集合中的任意字符。提示：集合由字符或范围组成。范围的格式为：字符 连字符，例如 AZ 或 0-9。集合支持的最小字符集为 [O-9a-zA-Z_]。</td></tr><tr><td><br>[!set] 或 [^set]</td><td><br>匹配不在指定集合中的任何字符。</td></tr><tr><td>一</td><td><br>抑制集合内字符 * []* ? !^ -' 的特殊句法意义，并精确匹配该字符。</td></tr></tbody></table>

下表显示了使用 preview.pcb 设计的命令参数中使用的正则表达式的示例，见表 47。

表 47. 快捷键表达式示例

<table><thead><tr><th><br>快捷键</th><th><br>结果</th></tr></thead><tbody><tr><td><br>哈*</td><td><br>突出显示所有以 A 开头的网络，例如 AoO、AO1、A02。</td></tr><tr><td><br>氢+??</td><td><br>突出显示所有以 + 开头、O 后有两位数字或字符的网络，例如 +5V。</td></tr><tr><td>HA?0</td><td><br>突出显示所有以 A 开头、以 0 结尾以及中间任意字符的网络，例如 Aoo 和 A10。</td></tr><tr><td><br>H[CD]*</td><td><br>突出显示所有以 C 或 D 开头的网络，例如 CLKIN、D00。</td></tr><tr><td><br>H [!CD]*</td><td><br>突出显示所有不以 C 或 D 开头的网络，例如 Aoo、GND。</td></tr></tbody></table>
...
重新排列窗口中的选项卡 在窗口之间移动选项卡 将选项卡转换为窗口
