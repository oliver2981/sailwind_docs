...
| 元素 | 描述 |
| --- | --- |
| 零件类型 | 零件的电气信息。这包括逻辑系列、CAE 贴图分配、零件名称、连接引脚、门交换信息、属性等。另请参阅修改零件的电气信息。 |
...
> [!TIP]
：使用“零件编辑器”的“绘图”工具栏修改贴花向导创建的基本信息。您可以添加其他端子、更改引脚贴花或更改引脚序列号。
...
| 类别 | 描述 |
| --- | --- |
| 引脚数 | 显示零件中的引脚总数。包括栅极引脚、信号引脚和未使用的引脚。如果为多个贴花指定了不同的引脚数，则会显示从最小到最大的贴花引脚数范围。 |
