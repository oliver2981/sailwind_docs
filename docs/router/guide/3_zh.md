...
**提示** 您也可以观看 S ailWind Route r 中用于布局和布线设计的高级功能视频。请参阅 S ailWind Route r 网络表项目介绍视频。
...
1. 按照["启用同步模式"第 3  3 页](#page-4-1)所述启用同步模式。
...
**提示** 要切换回 S ailWind Router，请单击 S ailWind Layou t 主工具栏上的**布线**按钮。
