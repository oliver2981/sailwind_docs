...
| 按网络启用颜色            | Y     | 根据"查看网络对话框"第 538 页中的设置，切换是否将自定义颜色应用于网络焊盘、管脚、过孔和（可选）导线。                                                           |
...
|                                                                                |               | 提示您还可以显示单个电气层（使用 Z C 使当前层可见），然后使用 Alt+滚轮向后或 Alt+滚轮向前将显示切换到相邻电气层，跳过任何非电气层。                                                                                                                             |
| 查看所有内层                                                                   | Z I           | 查看所有内层。                                                                                                                                                                                                                                                  |
...
| 高亮带规则的元件焊盘                                                    | HCR           | 高亮带当前高亮对象显示第 441 页设置的元件焊盘，表示元件有元件规则。使用元件规则时会显示其他指示器。更多信息，请参见第 308 页"使用元件规则创建导线"。                                                                                   |
...
| 名称       | 命令 | 说明                                                                                               |
|----------|-------|---------------------------------------------------------------------------------------------------|
| 推挤背后导线模式 | PB    | 在交互式布线期间为当前导线临时切换推挤背后导线开或关。                                                |
| 点击后布线模式  | PC    | 在交互式布线期间为当前导线临时启用点击后布线模式。                                                |
| 指针布线模式   | PP    | 在交互式布线期间为当前导线临时启用指针布线模式。                                                  |
| 切线模式     | PR    | 在交互式布线期间为当前导线临时启用布线器切线模式。                                                |
| 无拉线器     | PX    | 在交互式布线期间为当前导线临时禁用布线。                                                          |
...
| 方向引导                           | DG    | 当您移动导线段时切换方向引导开或关。方向引导是从指针辐射出的线，指示您可以继续的方向。                                                                                                      |
...
|                | 命令 | 说明                                                                                                                                  |
|----------------|-------|--------------------------------------------------------------------------------------------------------------------------------------|
| 基本日志测试   | BLT   | 基本日志测试。打开日志测试对话框。BLT 查找并运行 BMW 会话回放媒体。另请参见第 576 页"崩溃检测"                                          |
| 打开基本媒体向导          | BMW     | 打开基本媒体向导对话框。• BMW 为有问题的 SailWind Logic、SailWind Layout 或SailWind Router 会话记录会话回放媒体。它可以基于您上次 SailWind 会话或当前会话创建回放媒体。此回放媒体可以使用 BLT 无模命令回放。• BMW 也是命令行选项。另请参见第 576 页"崩溃检测"                                                                                           |
...
| 打开快捷键对话框，您可以查看正在输入的按键序列、快捷键信息和语法（如果可用）。                                                     | 快捷键具有以下任一特征：• 一个或多个命令参数• 长快捷键• 与其他快捷键相似                                                       |
...
| 蛇形导线开始（交互式布线模式）                              | Shift + A                | 开始蛇形导线，交互式布线模式。                                                                                                                                  |
| 结束蛇形导线                                                                  | LMB 双击             | 结束蛇形导线，交互式布线。                                                                                                                                        |
| 动态重新连接开/关                                                       | Shift + N                | 切换动态重新连接开或关。                                                                                                                                           |
| 动态模式开/关                                                           | Shift + D                | 切换动态模式开或关，交互式布线。                                                                                                                       |
...
| 左键点击                                         | `<spacebar>` | 在当前指针位置激活左键点击（添加拐角、选择项目、完成等）。 |
