...
| 切换导线上网络名称显示                   | NNT   | 切换导线上网络名称显示开/关。<br>提示<br>此命令切换选项对话框 > 颜色类别中的"导线上网络名称"复选框。<br>限制：<br>网络名称的显示还取决于"网络名称列（可见性）复选框和选项对话框 >` 颜色类别中该层上非背景颜色块的存在。                                                                                                          |
...
| 蛇形导线开始<br>（交互式布线模式）                              | Shift + A                | 开始蛇形导线，交互式布线模式。                                                                                                                                  |
...
| 切换规则                                                                   | Shift + R                | 切换规则。                                                                                                                                                                |
| 切换导线（单独<br>布线模式）                                        | `<tab>`              | 切换导线，单独布线模式。                                                                                                                                         |
| 显示备用导线长度<br>（差分对模式中的导线长度监视器） | `<tab>`              | 显示差分对中备用导线的长度。<br>将此与导线长度监视器一起使用以检查<br>差分对每个成员的长度。 |
