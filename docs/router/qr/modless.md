...
|----------------------|-------------------------------------------------------------------------------------------------------------------------|
| 命令              | 描述                                                                                                             |
| G <x> {<y>}</y></x>  | 设置所有网格（布线、测试点、过孔、扇出、元件），除显示网格外                               |
| GC <x> {<y>}</y></x> | 设置元件网格                                                                                                  |
...
| W <n></n>            | 将当前导线或线宽更改为<n>，例如 W 5</n>                                                              |

|                    | 推挤设置                                                      |
|--------------------|-------------------------------------------------------------------------|
| 命令            | 描述                                                             |
| PB                 | 切换推挤导线后模式开/关（当前导线）                    |
| PC                 | 启用点击后推挤模式（当前导线）                            |
| PP                 | 启用指针推挤模式（当前导线）                           |
| PR                 | 启用推挤拆除模式（当前导线）                               |
| PX                 | 禁用推挤（当前导线）                                         |
...
| 命令                    | 描述                                                                                  |  |
| DRC                        | 切换在线 DRC 模式                                                                      |  |
| SUS                        | 在元件移动时，暂停光标以检查错误电子表格标签上的 DRC 问题 |  |
| 测量                |                                                                                              |  |
|                            |                                                                                              |  |
| 命令                    | 描述                                                                                  |  |
| Q                          | 使用动态规则快速测量                                                             |  |
