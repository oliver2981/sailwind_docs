...
287Schematic Object Modification
...
Selecting This Instance will cause the net to be split into two separate nets.
...
conform to the bit sequenced names, which you define in the Bus Name text box. Before 
