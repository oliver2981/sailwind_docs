...
4. 在"多元件向导对话框"第 76 页中进行所需的设置。

5. 完成向导设置后，可以在"焊盘图形向导对话框"第 82 页中设置 `CAD` 输出选项。

👀‍**结果**

["多元件向导报告.txt 日志文件"第 78 页](#page-11-0)会自动生成并显示在您的文本编辑器中。
...
- 在焊盘图形列表中，**右键**单击，指向工具并单击向导。

多元件向导对话框用于设置多元件向导。仔细查看本主题中的内容，以确保您获得预期的结果！设置包括制造和装配公差、舍入、间距和环境。
...
| 为所有元件生成新描述                                         | 选择生成新描述；未选中时，将保存<br>原始库文件中的描述。<br>注意：<br>如果您手动编辑或创建<br>了焊盘图形的描述并且不想丢失<br>这些描述，请不要选中此框！ |
| 为所有元件生成新焊盘栈                                     | 选择为选定的焊盘图形生成新焊盘栈名称；<br>未选中时，将保存原始库中的焊盘栈名称。<br>注意：<br>如果您手动编辑或创建了焊盘栈<br>名称并且不想丢失这些<br>名称，请不要选中此框！ |
