...
| 本地存档                           | 如果有本地访问数据的链接可用，此按钮将启用并可用于打开为选定焊盘图形提供的数据文件。                                                                                                                                                                                                                                                                                                                                                                                                           |
| 工具（搜索模式下不可用） | 下拉菜单选项包括：• 验证 - 使用当前用户偏好重新计算当前库并与当前库文件中包含的参考值进行比较（参见帮助主题"验证焊盘图形"第 73 页）。• 向导 - 根据某些用户选项重新计算当前库（参见帮助主题"运行多元件向导"第 74 页）。• 链接检查器 - 此工具可定期用于验证在线链接数据网站的有效性（参见帮助主题"运行链接检查器"第 79 页）。 |
...
| 名称                                 | 描述                                                                                                                                                                                                                                   |
|--------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 查看（与工具栏功能相同）  | • 屏幕上• 在线链接• 本地存档                                                                                                                                                                                                             |
| 新建                                  | • 行 - 向库数据表添加新行。• 列 - 向库数据表添加新列。                                                                                                                                                                                       |
| 复制                                 | 将单元格的内容（如果选中单元格且其内容为高亮显示）或行（如果通过单击行标题选中整行）复制到 Windows 剪贴板。可以选择并复制多行。 |
