...
[Setting an Existing Extension Line as the Baseline](#page-8-1)
...
This mode remains in effect until you select another. Also use the shortcut menu to set the [snap](#page-10-0) [modeon page 925](#page-10-0).
