...
Report Types Running a Report Running a Report Using an Assembly Variant Adding or Removing Report Formats Creating Custom Reports Using the Report Wizard
...
To help you select the proper report, report files are listed in the Reports dialog box by description of output, instead of by file name. Table 124lists the formats, file names, and their descriptions.
...
You can create a Jumper List Report that lists all jumpers and their characteristics. Table 125shows a sample report file.
...
If the report format you want is not available, you can create a custom format, see "Adding or  Removing Report Formats" or "Creating Custom Reports Using the Report Wizard".
...
For more information, see Customizable Reports.
