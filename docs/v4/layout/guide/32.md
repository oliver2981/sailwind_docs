...
**Figure 92. Parallel Vias from Middle Guide Route**

![](/layout/guide/32/_page_14_Picture_4.jpeg)

**Perpendicular**

Vias are added in a row, perpendicular to the direction in which the bus is traveling. When the guide route is one of the middle routes, the remaining routes adjust on either side of the pattern ([Figure 93](#page-14-2)).
...
Vias are added in a diagonal, at a negative 45-degree angle to the direction in which the bus is traveling. If the guide route is one of the middle routes, the remaining routes adjust on either side of the pattern [\(Figure 95\)](#page-15-1).
...
Vias are added in a diagonal, at a positive 45-degree angle to the direction in which the bus is traveling [\(Figure 96\)](#page-15-2).
