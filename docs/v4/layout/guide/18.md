...
Read the topics that follow to learn more about creating, modifying, managing and using attributes in SailWind Layout.
...
[Default and Other Attribute Properties and Usage](#page-3-1) [Modifying the Default Attribute Dictionary](#page-16-0) [Assignment of Attributes](#page-17-0) [Attribute](#page-19-0) Values [Attribute](#page-28-0) Types
...
For more information, see the ["Modifying Design Attribute Properties"on page 389](#page-34-1) and ["Modifying the](#page-16-0)  [Default Attribute Dictionary"on page 371](#page-16-0) topics.

SailWind Layout also provides a default set of units (and unit prefixes) that are accepted as input and used as output. For more information, see [Default Units](#page-23-0).
...
- 11. For more information, see "[Number/Decimal](#page-20-0) Number Attribute Values and ECO".
