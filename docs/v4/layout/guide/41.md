...
The aperture report opens in the default text editor.
...
For more information, see "Software Launch Options".
...
Select the Show Difference check box and view the updated list with only the differences.
...
For more information, see "Running a Report Using an Assembly Variant".
...
[Setting the Printer to Print to a File](#page-44-1) [Printing a CAM Document to a File](#page-44-2)
