...
**Tip** Use the **Routing** category > [General subcategoryon page 1542](#page-109-0) to enable teardrops.
...
- [Status](#page-128-1) Tab Displays information on the current session.
- [Macro](#page-128-2) Tab Allows you to run, edit and debug macro scripts.
