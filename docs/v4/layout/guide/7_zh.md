...
**提示** 您可以点击"检查封装"按钮，检查封装与所有关联零件类型的匹配情况，显示所有管脚编号不匹配错误
...
10. 选择另一个端子分配下一个可用编号
    ...
    **提示** 如果重编号所有可用管脚，会显示"重新编号...新编号已用完！"消息
...
**提示** 封装上的管脚编号更改在点击**应用**或**确定**后才会更新
...
**提示** 使用"过孔、焊盘和走线"复选框以及"带关联铜箔的管脚"区域中的选项，可以完全控制 CAM 文档中显示的内容。
