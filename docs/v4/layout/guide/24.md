...
The Virtual Pin Virtual Pin Setup Adding a Virtual Pin to a Net Moving a Virtual Pin Deleting a Virtual Pin Converting a Virtual Pin to a Via Gluing a Virtual Pin Changing a Virtual Pin's Via Type Support for Export to Other Formats ECO Import Support Reuses Support
