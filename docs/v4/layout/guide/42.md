...
The following topics discuss the embedding of OLE objects in SailWind Layout, the characteristics of embedded objects, and the operations you can perform on them.
...
Updates are automatically reflected in the object.
